    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                <ul>
                    ...
                    @foreach($parentCategories as $rs)
                        <li>
                            <a href="#" class="stext-107 cl7 hov-cl1 trans-04">{{$rs->title}}</a>
            ...
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                <ul>
                    <li class="p-b-10">
                        <a href="{{route('asked_questions')}}" class="stext-107 cl7 hov-cl1 trans-04">
            ...
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                <div class="p-t-27">
                    ...
                    @if ($setting->instagram !=null)
                        <a href="{{$setting->instagram}}" class="fs-18 cl7 hov-cl1 trans-04 m-r-16">
                    ...
                    @if ($setting->linkedin !=null)
                        <a href="{{$setting->linkedin}}" class="fs-18 cl7 hov-cl1 trans-04 m-r-16">
