                ...
                <div class="col-md-6 col-lg-7 p-b-30">
                    <div class="p-l-25 p-r-30 p-lr-0-lg">
                        <div class="wrap-slick3 flex-sb flex-w">
                            ...
                            <div
                                class="slick3 gallery-lb"> @foreach(\App\Models\Image::where('product_id',$product->id)->get() as $photo)
                                        ...
                                        <div> @foreach($reviews as $rs)
                                                <div class="flex-w flex-t p-b-68">
                                                    <div class="wrap-pic-s size-109 bor0 of-hidden m-r-18 m-t-6">
                                                        <img src="{{Storage::url($rs->user->profile_photo_path)}}"
                                                             alt="AVATAR">
                                                    </div>
                                            ...
                                            @endauth
                                            @guest()
                                                <p>Yorum yapmak için giriş yapmanız gerekiyor. Giriş yapmak için <a
                                                        href="/userLogin">buraya</a> tıklayın.</p>
