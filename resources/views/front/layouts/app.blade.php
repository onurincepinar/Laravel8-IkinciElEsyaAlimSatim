...
<body class="animsition">
	...
	<header class="@yield('header-class')">
		...
		<div class="container-menu-desktop">
			...
			<div class="wrap-menu-desktop @yield('wrap-menu-shadow')">
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							...
							<li class="label1" data-label1="hot">
								<a href="{{ route('shoping-cart') }}">Features</a>
							</li>
		...
		<div class="menu-mobile">
			...
			<ul class="main-menu-m">
				...
				<li>
					<a href="{{ route('shoping-cart') }}" class="label1 rs1" data-label1="hot">Features</a>
				</li>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | <a href="#" target="_blank">Onur İncepınar</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
